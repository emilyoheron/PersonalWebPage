  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-screen p-8 bg-gray-100 dark:bg-gray-800">
      ...
      <Image
        ...
        <p className="text-gray-600 dark:text-gray-300 mb-8">Web Developer and Enthusiast</p>
        <div className="text-left">
          <h2 className="text-xl font-semibold mb-4">About Me</h2>
          <p className="text-gray-800 dark:text-gray-200 mb-6">
            I am a December 2023 graduate of the University of Illinois at Chicago with a degree in Computer Science. Throughout my academic journey, I have honed my skills in object-oriented programming, GUI and backend development, and completed hands-on projects that demonstrate my ability to solve complex problems and create efficient solutions.<br/><br/>
